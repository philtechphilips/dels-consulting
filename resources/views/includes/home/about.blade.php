<section class="w-full py-28 flex md:flex-row flex-col relative">
    <div
        class="bg-[#CDDDF5] relative md:rounded-r-full px-5 md:pl-16 md:pr-28 py-28 md:w-[750px] flex flex-col md:justify-start md:items-start justify-center items-center">
        <h1 class="md:text-4xl text-3xl z-[1000] font-bold text-[#010101] md:text-left text-center">Welcome To <span
    ...
    <div class="md:flex gap-4 items-center z-[1000] -ml-28 hidden">
        <div>
