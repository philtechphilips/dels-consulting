<section class="md:w-[602px] md:px-20 px-5 mb-10 relative">
   <div class="z-[1000000]">
    <h1 class="font-bold md:text-5xl mb-3 text-center md:text-left text-3xl z-[1000000]">Our <span class="text-[#0454CB]">Services</span></h1>
    <p class="text-lg text-[#4F4F4F] text-center md:text-left">In this section, discover the comprehensive range of services we offer to elevate your business. </p>
   </div>
...
<section class="w-full md:pr-24 pr-5 md:py-14 pb-28 flex flex-col md:flex-row items-center gap-10">
    ...
    <div class="flex flex-col items-center md:items-start gap-2 md:w-1/2 px-5">
        ...
        <p class="md:text-lg font-medium text-[#4F4F4F] text-center">
            Our expert team crafts stunning mobile applications tailored to your needs, ensuring seamless functionality and captivating design. Learn more about our app development services today!
        </p>
        <a href=""
    ...
    <div
        ...
        <div class="z-[100] md:w-[700px] w-full flex flex-col items-center gap-3">
            ...
            <p class="font-medium text-lg text-[#4F4F4F] text-center md:text-left">
                To make your business very special and eye-catching, we design your website and application with a very professional team that will nail the user!
...
<section class="md:pr-24 flex md:flex-row flex-col-reverse md:items-center gap-10 mt-10">
    ...
    <div class="md:w-1/2 px-5 flex flex-col items-center md:justify-start md:items-start justify-center">
        ...
        <p class="text-[#4D4F51] md:text-lg text-center md:text-left">Dominate search engine rankings with our top-notch SEO Services. Our comprehensive strategies drive organic traffic and boost your online visibility. Ready to climb the search results? Click below to learn more and elevate your online presence today!</p>
        <a href=""
...
<section class="md:px-24 hidden md:block px-5"
    ...
    <div class="flex md:flex-row flex-col md:ml-36 py-40 gap-5">
        <div class="flex flex-col items-center md:items-start justify-center gap-4 mt-10 md:w-[480px]">
            ...
            <p class="text-[#4F4F4F] text-lg">Custom website development by our expert website developers. Front-end & design, backend, database, and server scale designed to fit your custom workflow.
            </p>
            <a href=""
